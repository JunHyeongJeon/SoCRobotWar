...
//STATE_BRIDGE_WALK_SHORT,	// 다리 위에서 걷기
//STATE_BRIDGE_WALK_LONG,	// 다리 위에서 
//STATE_HEAD_LEFT_THIRTY,
//STATE_HEAD_RIGHT_THIRTY,
//STATE_HEAD_LEFT_SIXTY,
//STATE_HEAD_RIGHT_SIXTY,
//STATE_HEAD_LEFT_NINETY,
//STATE_HEAD_RIGHT_NINETY,
//STATE_STEP_LEFT,
//STATE_STEP_RIGHT,
//STATE_TURN_LEFT,
//STATE_TURN_RIGHT,
//STATE_TURN_LEFT_RIGHT_ANGLE,
//STATE_LINE_CHECK,

const float c_fStateTime[] = 
{
	1.5,		//STATE_STAY
	3.4,		//STATE_WALK_THREE
	0.5,		//STATE_TURN_LEFT
	0.5,		//STATE_TURN_RIGHT
	2.6,		//STATE_LOOK_SIDE_LINE
	2.4,		//STATE_AFTER_LOOK_LINE
	0.7,		//STATE_STEP_LEFT
	0.7,		//STATE_STEP_RIGHT
	0.7,		//STATE_HEAD_LEFT
	0.7,		//STATE_HEAD_RIGHT
	0.7,		//STATE_HEAD_CENTER
	3.6,		//STATE_TURN_LEFT_90
	3.6,		//STATE_TURN_RIGHT_90
	1.5,		//STATE_SIT_DOWN
