...
{
	1.5,		// 0.  MOTION_STAY
	3.7,		// 1.  MOTION_WALK_ONE
	3.7,		// 2.  MOTION_WALK_TWO
	3.7,		// 3.  MOTION_WALK_THREE
	4.6,		// 4.  MOTION_WALK_BARI
	0.5,		// 5.  MOTION_TURN_LEFT
	0.5,		// 6.  MOTION_TURN_RIGHT
	2.6,		// 7.  MOTION_LINE
	...
	4.2,		// 14. MOTION_TURN_LEFT_90
	4.2,		// 15. MOTION_TURN_RIGHT_90
	1.5,		// 16. MOTION_SIT_DOWN
	24.5,		// 17. MOTION_CREEP
	0.8,		// 18. MOTION_LINE_FRONT
	4.7,		// 19. MOTION_RUN
